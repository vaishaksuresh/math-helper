    ...
    <div className="space-y-8 animate-slide-in">
      ...
      {allSessions.length === 0 && (
        <div className="text-center py-16">
          ...
          <p className="text-gray-500">No sessions yet. Start practicing to see your history here!</p>
      ...
      {active.length > 0 && (
        <section>
          <h2 className="text-lg font-bold text-gray-700 mb-3">In Progress ({active.length})</h2>
      ...
      {completed.length > 0 && (
        <section>
          <h2 className="text-lg font-bold text-gray-700 mb-3">Completed ({completed.length})</h2>
          <div className="space-y-3">
      ...
      {quit.length > 0 && (
        <section>
          <h2 className="text-lg font-bold text-gray-700 mb-3">Quit Early ({quit.length})</h2>
          <div className="space-y-3">
